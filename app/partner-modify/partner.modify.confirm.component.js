...
var PartnerModifyConfirmedComponent = (function () {
    function PartnerModifyConfirmedComponent(_activatedRoute, _router, _partnerDeleteServices) {
        this._activatedRoute = _activatedRoute;
        this._router = _router;
        this._partnerDeleteServices = _partnerDeleteServices;
        this._isLoading = true;
    }
    PartnerModifyConfirmedComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    PartnerModifyConfirmedComponent = __decorate([
        core_1.Component({
    ...
    return PartnerModifyConfirmedComponent;
}());
exports.PartnerModifyConfirmedComponent = PartnerModifyConfirmedComponent;
//# sourceMappingURL=partner.modify.confirm.component.js.map