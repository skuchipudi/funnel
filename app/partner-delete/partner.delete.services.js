...
var PartnerDeleteServices = (function () {
    function PartnerDeleteServices(_http) {
        this._http = _http;
        this.partner_delete_url = 'http://localhost:8080/partnerservices/delete/';
    }
    PartnerDeleteServices.prototype.deletePartner = function (partnerId) {
    ...
    return PartnerDeleteServices;
}());
exports.PartnerDeleteServices = PartnerDeleteServices;
//# sourceMappingURL=partner.delete.services.js.map