...
var FileMapService = (function () {
    function FileMapService() {
    }
    ...
    FileMapService.prototype.renderTree = function (partnerid) {
        ...
        d3.json('d3/d3.json', function (error, flare) {
            d3.json('http://localhost:8080/partnerservices/getclienttree/' + partnerid, function (error, flare) {
                if (error)
                    throw error;
                root = flare;
                root.x0 = height / 2;
    ...
    FileMapService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [])
    ], FileMapService);
    return FileMapService;
}());
exports.FileMapService = FileMapService;
//# sourceMappingURL=filemap.service.js.map